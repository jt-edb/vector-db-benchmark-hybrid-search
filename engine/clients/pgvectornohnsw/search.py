...
from engine.clients.pgvectornohnsw.parser import PgvectorNoHnswConditionParser


class PgvectorNoHnswSearcher(BaseSearcher):
    ...
    parser = PgvectorNoHnswConditionParser()
